...
/*    $scope.prefix = ['Mr.', 'Mrs.', 'Ms.'];*/
    ...
    $scope.ptaSelectedCosts = function(ptaAcctObj, ptaSecondaryAcct, ptaMembershipCosts, ptaMembershipForm){
        ...
        //console.log('ptaregistrationCtrl.ptaSelectedCosts: ' + JSON.stringify(ptaMembershipCosts) );
        ...
        console.log('ptaregistrationCtrl.ptaAcctObj ' + JSON.stringify(ptaAcctObj));
        //console.log('ptaregistrationCtrl.member ' + JSON.stringify(member));
